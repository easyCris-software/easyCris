/**
 * R Baseline Validation: Dose-Response 4PL Batch Interpolation CSV
...
async function runTest() {
  ...
  try {
    logStep('Starting Dose-Response 4PL batch interpolation CSV validation...')
    ...
    await exportPlotScreenshot(driver, 'dose_response_4pl', 300, 'interpolation_batch')
    logSuccess('Dose-Response 4PL batch interpolation CSV validation passed')
  } finally {
    if (driver && webdriver) {
