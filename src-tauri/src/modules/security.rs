...
pub fn validate_python_backend(backend_path: &str) -> Result<()> {
    ...
    const ALLOWED_PATHS: &[&str] = &[
        ...
        "python_embedded/dist/stats_backend.dist/stats_backend.exe",
        "python_embedded/dist/stats_backend.exe",
        "python_embedded/dist/rnaseq_backend.dist/rnaseq_backend.exe",
        "python_embedded/dist/plot_backend.dist/plot_backend.exe",
    ];
