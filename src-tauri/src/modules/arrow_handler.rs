...
mod tests {
    ...
    fn test_validate_path() {
        assert!(ArrowHandler::validate_path("data.arrow").is_ok());
        assert!(ArrowHandler::validate_path("data.ipc").is_ok());
        assert!(ArrowHandler::validate_path("data.feather").is_ok());
