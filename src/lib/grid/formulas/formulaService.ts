...
export const EXCEL_FUNCTIONS = {
  ...
  reference: [
    ...
    'MATCH', 'OFFSET', 'ROW', 'ROWS', 'TRANSPOSE', 'VLOOKUP', 'XLOOKUP',
  ],
  // Information
  information: [
...
type BackendFunctionPolicy = {
  name: string
  backendSupport: 'scalar' | 'array'
  spillRisk: 'none' | 'spill'
  autocompleteVisible: boolean
}

// Canonical backend function policy for routing + autocomplete.
const BACKEND_FUNCTION_POLICY: readonly BackendFunctionPolicy[] = [
  // Existing scalar backend functions
  { name: 'MEDIAN', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'LARGE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SMALL', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'STDEV.P', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'STDEV.S', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'VAR.P', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'VAR.S', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'MODE.SNGL', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'RANK.AVG', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'RANK.EQ', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PERCENTILE.EXC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PERCENTILE.INC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'QUARTILE.EXC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'QUARTILE.INC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'COUNTA', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'COUNTBLANK', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'COUNTIFS', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SUMIFS', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'AVERAGEIFS', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'LEN', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'UPPER', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'VALUE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SUBSTITUTE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'TEXTJOIN', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'MATCH', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'XLOOKUP', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'OFFSET', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },

  // Newly enabled non-spill scalar functions
  { name: 'ACCRINT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'ACCRINTM', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'CONVERT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'CUMIPMT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'CUMPRINC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'DB', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'DDB', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'DOLLARDE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'DOLLARFR', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'EFFECT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'ERF.PRECISE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'FV', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'IPMT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'IRR', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'MIRR', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'NOMINAL', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'NPER', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'NPV', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PEARSON', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PERCENTRANK.EXC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PERCENTRANK.INC', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PERMUT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PMT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PPMT', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PRICE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'PV', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'RATE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'RSQ', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SKEW', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SLN', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SLOPE', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'STEYX', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'SYD', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'TRIMMEAN', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'XIRR', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'XNPV', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'YIELD', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },
  { name: 'Z.TEST', backendSupport: 'scalar', spillRisk: 'none', autocompleteVisible: true },

  // Spill-capable functions deferred until full spill engine support.
  { name: 'CHOOSE', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'CHOOSECOLS', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'CHOOSEROWS', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'DROP', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'FILTER', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'HSTACK', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'ISFORMULA', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'LINEST', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'LOGEST', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'MODE.MULT', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'SEQUENCE', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'TAKE', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'TREND', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'UNIQUE', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
  { name: 'VSTACK', backendSupport: 'array', spillRisk: 'spill', autocompleteVisible: false },
]

// Scalar functions supported by backend and safe for single-cell results.
const BACKEND_SCALAR_FUNCTIONS = new Set<string>(
  BACKEND_FUNCTION_POLICY
...
// Array functions supported by backend but deferred without spill engine support.
const BACKEND_ARRAY_FUNCTIONS = new Set<string>(
  BACKEND_FUNCTION_POLICY
...
// Combined set of all backend-supported functions (exported for potential external use)
export const BACKEND_SUPPORTED_FUNCTIONS = new Set<string>([
  ...BACKEND_SCALAR_FUNCTIONS,
  ...BACKEND_ARRAY_FUNCTIONS,
])

// Limit autocomplete to functions we expose in the UI.
...
// Explicitly exclude functions that are cataloged but not runtime-safe yet.
...
try {
  ...
  if (Array.isArray(supported) && supported.length > 0) {
    ...
    // Keep spill-risk functions hidden until spill engine support is implemented.
    FILTERED_FUNCTIONS = ALLOWED_FUNCTIONS.filter(fn => {
      ...
      const parserVisible = SUPPORTED_FUNCTIONS_SET!.has(upperFn) && !BACKEND_ARRAY_FUNCTIONS.has(upperFn)
  ...
  FILTERED_FUNCTIONS = ALLOWED_FUNCTIONS.filter(fn => {
    const upperFn = fn.toUpperCase()
    return !BACKEND_ARRAY_FUNCTIONS.has(upperFn) && !EXCLUDED_AUTOCOMPLETE_FUNCTIONS.has(upperFn)
  })
...
export function getFunctionSignature(name: string): string | null {
  ...
  if (FUNCTION_SIGNATURES[upper]) return FUNCTION_SIGNATURES[upper]

  // Fallback: show a generic signature so every supported function gets a hint
  return `${upper}(...)`
}
...
export function getFunctionSuggestionsWithHints(prefix: string, limit = 10): FunctionSuggestion[] {
  ...
  // Filter to only include functions with proper signatures (not generic fallbacks)
  const withSignatures = matches
    .map((name) => {
      const signature = FUNCTION_SIGNATURES[name.toUpperCase()]
      if (!signature) return null // No signature defined, skip this function
      return { name, signature }
    })
    .filter((item): item is FunctionSuggestion => item !== null)

  // If we have enough functions with signatures, return those
  if (withSignatures.length >= limit) {
    return withSignatures.slice(0, limit)
  }

  // Otherwise, include some functions without signatures (showing only name)
  const withoutSignatures = matches
    .filter((name) => !FUNCTION_SIGNATURES[name.toUpperCase()])
    .slice(0, limit - withSignatures.length)
    .map((name) => ({
      name,
      signature: name, // Show just the function name without (...)
    }))

  return [...withSignatures, ...withoutSignatures].slice(0, limit)
}
import type {
  CellPosition,
  CellRef,
...
export class FormulaService {
  ...
  evaluate(
    ...
    if (
      ...
      (this.backendEvalContext.isSorted || this.backendEvalContext.isGrouped) &&
    ...
    if (largeRangeSpec && this.asyncAggregateContext) {
      const { isLargeDataset, isSorted, isGrouped, enqueueAggregate } = this.asyncAggregateContext
  ...
  private shouldUseBackendEval(
    ...
    const missingRowOrder = (ctx.isSorted || ctx.isGrouped) && (!ctx.rowOrder || ctx.rowOrder.length === 0)
    // CRITICAL: If dataset is sorted/grouped but rowOrder is missing, only proceed if we can resolve slices lazily.
    if (missingRowOrder && !ctx.supportsRowOrderSlice) {
      console.warn('[FormulaService] Backend eval blocked: sorted/grouped data but rowOrder missing')
      return false
    }
    ...
    // TODO: Add checks for unsupported functions or spill functions if needed
  ...
  private usesBackendScalarFunctions(formula: string): boolean {
    const functions = this.extractFunctionNames(formula)
    if (functions.length === 0) return false
    return functions.some(fn => BACKEND_SCALAR_FUNCTIONS.has(fn))
  }

  /**
   * Detect if formula uses backend array functions (FILTER, UNIQUE, etc.)
   * These return arrays and would cause #SPILL! in single-cell context.
   */
  private usesBackendArrayFunctions(formula: string): boolean {
    const functions = this.extractFunctionNames(formula)
    if (functions.length === 0) return false
    return functions.some(fn => BACKEND_ARRAY_FUNCTIONS.has(fn))
  }
  ...
  private getBackendFallbackFunction(formula: string, message?: string): string | null {
    ...
    for (const fn of functions) {
      if (BACKEND_SCALAR_FUNCTIONS.has(fn)) {
  ...
  private tryBackendFallback(
    ...
    if (BACKEND_ARRAY_FUNCTIONS.has(fn)) {
      return null
    }
    if (!BACKEND_SCALAR_FUNCTIONS.has(fn)) {
      return null
