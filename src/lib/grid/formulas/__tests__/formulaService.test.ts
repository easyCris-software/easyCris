...
describe('FormulaService', () => {
  ...
  describe('Cell reference evaluation', () => {
    it('evaluates =A1 correctly', () => {
      const position: CellPosition = { row: 1, col: 1, sheet: 'Sheet1' } // B1
  ...
  describe('Function evaluation', () => {
    ...
    // Note: MIN/MAX are not implemented in fast-formula-parser
    it.skip('evaluates =MIN(A1:A5) correctly', () => {
      const position: CellPosition = { row: 1, col: 1, sheet: 'Sheet1' }
    ...
    // Note: MIN/MAX are not implemented in fast-formula-parser
    it.skip('evaluates =MAX(A1:A5) correctly', () => {
      const position: CellPosition = { row: 1, col: 1, sheet: 'Sheet1' }
