...
export function WilcoxonColumnMapperDialog({
  ...
  const hasDuplicates = useMemo(() => {
    const groupOutcomeDup = mapping.group && mapping.outcome && mapping.group === mapping.outcome
    if (isWideFormat) {
      return Boolean(groupOutcomeDup)
    }
    const groupPairDup = mapping.group && mapping.pair_id && mapping.group === mapping.pair_id
