...
export function TwoWayFactorMappingDialog({
  ...
  const handleFieldChange = useCallback((fieldKey: keyof TwoWayFactorMapping, value: string) => {
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm text-gray-600">
            Choose which factor should be the primary (x-axis) and which should be the secondary
            (grouping) for Two-Way ANOVA analysis and plots.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="rounded-md bg-blue-50 border border-blue-200 p-3 text-sm text-blue-900">
          <p>
            <strong>Tip:</strong> Factor A typically represents the primary treatment or condition
            (x-axis), while Factor B represents the secondary grouping variable (colors/legend).
            This assignment affects plot layout and interaction interpretation.
          </p>
        </div>
