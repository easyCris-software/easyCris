...
const FIELD_DEFINITIONS: FieldDefinition[] = [
  {
    ...
    description:
      'Independent variable: dose, concentration, or treatment level',
    icon: Beaker,
  },
  {
    key: 'response',
...
export function DoseResponseColumnMapperDialog({
  ...
  const handleFieldChange = useCallback(
    (fieldKey: keyof DoseResponseColumnMapping, value: string) => {
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className={dialogDescriptionClass}>
            Map your data columns to the dose-response analysis fields. Each row
            should contain a dose/concentration value and its corresponding
            measured response.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className={dialogInfoPanelClass}>
          <p>
            <strong>Tip:</strong> The dose column contains your treatment
            concentrations (e.g., drug amounts, time points). The response
            column contains the measured biological effect (e.g., % inhibition,
