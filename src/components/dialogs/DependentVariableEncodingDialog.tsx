 ...
 *
 * Reference: easyCris.Avalonia/Views/StatisticalAnalysis/DependentVariableEncodingDialog.axaml.cs
 * Lines: 220 lines
 *
 * Features:
      ...
      <DialogContent className="max-w-2xl w-[95vw] max-h-[calc(100dvh-2rem)] flex flex-col overflow-hidden p-0">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden overscroll-contain px-6 py-4">
          <div className="space-y-6">
            ...
            {/* Encoding preview */}
            {encodingPreview && (
              <div className="rounded-md bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 p-4">
