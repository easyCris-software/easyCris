...
const KRUSKAL_POST_HOC_METHODS: {
  value: KruskalPostHocAdjustmentMethod
  label: string
}[] = [
...
export function KruskalWallisColumnMapperDialog({
  ...
  const [posthocMethod, setPosthocMethod] =
    useState<KruskalPostHocAdjustmentMethod>('bonferroni')
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5 border-t pt-4">
            ...
            <Select
              value={posthocMethod}
              onValueChange={v =>
                setPosthocMethod(v as KruskalPostHocAdjustmentMethod)
              }
            >
              <SelectTrigger
                className="w-full"
                data-testid="kruskal-adjustment-select"
              >
