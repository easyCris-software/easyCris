...
import { plotDataRequiresWebGL } from '@/utils/plotWebGL'
import { ScatterGLWebGLFallback } from './ScatterGLWebGLFallback'
...
export function PlotlyLazy({
  ...
  const webGLUnavailable = plotDataRequiresWebGL(props.data) && !isWebGLSupported()
